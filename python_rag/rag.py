def chatbot_response(query):
    ...
    def load_or_parse_data():
        data_file = "por\python_rag\data\parsed_data.pkl"
        ...
        if os.path.exists(data_file):
            ...
            parser = LlamaParse(api_key=llamaparse_api_key,
                                ...
                                max_timeout=5000,)
            llama_parse_documents = parser.load_data("por\python_rag\data\Jaganath_resume2024.pdf")
...
#print(chatbot_response("tell me about his projects?"))
